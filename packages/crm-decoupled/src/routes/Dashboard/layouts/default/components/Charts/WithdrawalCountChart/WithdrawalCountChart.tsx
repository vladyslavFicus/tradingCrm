...
import { useWithdrawalCountQuery } from 'routes/Dashboard/graphql/__generated__/WithdrawalCountQuery';
...
const WithdrawalCountChart = (props: Props) => {
  ...
  const {
    ...
    summaryList,
    handleSelectChange,
  } = useChart(useWithdrawalCountQuery, Charts.withdrawalCountStatistic);
