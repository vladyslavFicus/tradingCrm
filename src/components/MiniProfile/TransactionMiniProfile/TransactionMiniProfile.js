    ...
    >
      <div className="mini-profile-header">
        ...
        <div className="mini-profile-ids">
          {I18n.t('COMMON.AUTHOR_BY')} <Uuid uuid={data.createdBy} uuidPrefix={authorUuidPrefix} />
        </div>
        <div className="mini-profile-ids">
          {I18n.t('COMMON.DATE_ON', {
            date: moment
              .utc(data.creationTime)
              .local()
      ...
      <div className="mini-profile-content transaction-mini-profile-content">
        <div className="info-block">
          ...
          <div className="info-block-content">
            ...
            <div className="info-block-description">
              <Uuid uuid={data.createdBy} uuidPrefix={authorUuidPrefix} />
            </div>
          </div>
        </div>
        <div className="info-block">
        ...
        {data.paymentMethod && (
          <div className="info-block">
            ...
            <div className="info-block-content">
              <div className="info-block-heading">{data.paymentMethod}</div>
              {data.paymentAccount && (
                <div className="info-block-description">
