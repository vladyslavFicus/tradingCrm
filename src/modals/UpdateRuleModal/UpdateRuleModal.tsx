...
const UpdateRuleModal = (props: Props) => {
  ...
  return (
    <Modal className="UpdateRuleModal" toggle={onCloseModal} isOpen>
      <Formik
        initialValues={{
          name: name || '',
          type,
        ...
        enableReinitialize
      >
        {({ values, dirty, isSubmitting, errors, initialValues, setFieldValue }) => (
          <Form>
            <ModalHeader toggle={onCloseModal}>
              {I18n.t('HIERARCHY.PROFILE_RULE_TAB.EDIT_MODAL.HEADER')}
            </ModalHeader>

            <ModalBody className="UpdateRuleModal__body">
              <StaticTabs>
