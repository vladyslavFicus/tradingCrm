...
export const typesLabels: Record<string, string> = {
  ...
  [types.BRAND_DOCUMENT_ADDED]: 'CONSTANTS.AUDIT.TYPES.BRAND_DOCUMENT_ADDED',
  [types.BRAND_DOCUMENT_DELETED]: 'CONSTANTS.AUDIT.TYPES.BRAND_DOCUMENT_DELETED',
  [types.BRAND_DOCUMENT_UPDATED]: 'CONSTANTS.AUDIT.TYPES.BRAND_DOCUMENT_UPDATED',
  ...
  [types.CDE_MIGRATION_STARTED]: 'CONSTANTS.AUDIT.TYPES.CDE_MIGRATION_STARTED',
  ...
  [types.FAVOURITE_PAYMENT_SYSTEM_ADDED]: 'CONSTANTS.AUDIT.TYPES.FAVOURITE_PAYMENT_SYSTEM_ADDED',
  [types.FAVOURITE_PAYMENT_SYSTEM_DELETED]: 'CONSTANTS.AUDIT.TYPES.FAVOURITE_PAYMENT_SYSTEM_DELETED',
};
