...
const verifyRequestReasons = {
  ...
  WITHDRAWAL_OVER: I18n.t('PLAYER_PROFILE.PROFILE.SEND_KYC_REQUEST.REASONS.WITHDRAWAL_OVER'),
  SUSPECTED_FRAUD: I18n.t('PLAYER_PROFILE.PROFILE.SEND_KYC_REQUEST.REASONS.SUSPECTED_FRAUD'),
  SUSPECTED_ML: I18n.t('PLAYER_PROFILE.PROFILE.SEND_KYC_REQUEST.REASONS.SUSPECTED_ML'),
  SUSPECTED_IDENTITY_THEFT: I18n.t('PLAYER_PROFILE.PROFILE.SEND_KYC_REQUEST.REASONS.SUSPECTED_IDENTITY_THEFT'),
};
