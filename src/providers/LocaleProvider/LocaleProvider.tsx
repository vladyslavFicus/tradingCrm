...
const LocaleProvider = (props: Props) => {
  ...
  useEffect(() => {
    ...
    const crmLocaleKey = getCRMLocaleKey(props.locale);
    ...
    if (getCRMLocales().includes(crmLocaleKey)) {
      props.storage.set('locale', crmLocaleKey);
