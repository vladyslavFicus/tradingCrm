...
import { executionPeriodInHours } from 'constants/clientsDistribution';
import {
  FormikSelectField,
  FormikInputField,
...
const DistributionRuleSourceBrandForm = (props: Props) => {
  ...
  const clientsAmount = clientsAmountQuery.data?.distributionRuleClientsAmount;
  ...
  return (
    <div className="DistributionRuleSourceBrandForm">
      ...
      <Field
        name="sourceBrandConfig.executionPeriodInHours"
