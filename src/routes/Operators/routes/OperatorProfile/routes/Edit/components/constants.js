...
const personalFormAttributeLabels = {
  ...
  whiteListedIps: I18n.t('OPERATORS.PROFILE.PERSONAL_FORM.LABELS.WHITE_LISTED_IP'),
  restrictedCountries: I18n.t('OPERATORS.PROFILE.PERSONAL_FORM.LABELS.RESTRICTED_COUNTRIES'),
};
