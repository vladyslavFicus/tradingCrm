...
import './OperatorFeedsFilter.scss';
...
const OperatorFeedsFilter = (props: Props) => {
  ...
  return (
    ...
    >
      {({
        ...
        <Form className="OperatorFeedsFilter__form">
          <Field
            name="searchBy"
            className="OperatorFeedsFilter__field OperatorFeedsFilter__search"
          ...
          <Field
            name="auditLogType"
            className="OperatorFeedsFilter__field OperatorFeedsFilter__select"
          ...
          <Field
            className="OperatorFeedsFilter__field OperatorFeedsFilter__date-range"
          ...
          <div className="OperatorFeedsFilter__buttons">
            <RefreshButton
              className="OperatorFeedsFilter__button"
              onClick={onRefetch}
            />
...
export default React.memo(OperatorFeedsFilter);
