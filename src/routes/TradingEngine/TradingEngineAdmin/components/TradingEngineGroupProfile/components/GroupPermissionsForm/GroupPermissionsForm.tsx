    ...
    <div className="GroupPermissionsForm__fields">
      <div className="GroupPermissionsForm__field">
        <div className="GroupPermissionsForm__title">
          {I18n.t('TRADING_ENGINE.GROUP_PROFILE.PERMISSIONS_GROUP_FORM.TITLE')}
        </div>
      </div>
      <Field
        name="useSwap"
        component={FormikCheckbox}
        label={I18n.t('TRADING_ENGINE.GROUP_PROFILE.PERMISSIONS_GROUP_FORM.ENABLE_CHARGE_OF_SWAPS')}
        className="GroupPermissionsForm__field"
      />
      <Field
        name="hedgeProhibited"
        component={FormikCheckbox}
        label={I18n.t('TRADING_ENGINE.GROUP_PROFILE.PERMISSIONS_GROUP_FORM.PROHIBIT_HEDGE_POSITIONS')}
        className="GroupPermissionsForm__field"
      />
    </div>
  </div>
