  ...
  <div className="GroupMarginsForm">
    <div className="GroupMarginsForm__fields">
      ...
      <Field
        ...
        type="number"
        label={I18n.t('TRADING_ENGINE.GROUP_PROFILE.MARGINS_GROUP_FORM.MARGIN_CALL_LEVEL')}
      ...
      <Field
        ...
        component={FormikInputField}
        type="number"
        label={I18n.t('TRADING_ENGINE.GROUP_PROFILE.MARGINS_GROUP_FORM.STOP_OUT_LEVEL')}
        className="GroupMarginsForm__field"
      />
    </div>
  </div>
