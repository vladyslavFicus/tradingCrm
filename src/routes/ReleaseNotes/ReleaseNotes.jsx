...
const ReleaseNotes = () => (
  <Fragment>
    ...
    <ul className="ak-ul">
      <li>
        <p>Implemented functionality to distribute incoming client traffic between sales operators in BO according to
          certain percentage sales rules</p>
      </li>
      <li>
...
<If condition={getActiveBrandConfig().regulation.isActive}>
  <h2 id="03/Apr/20---Version-37">03/Apr/20 - Version 37</h2>
  <div className="heading-anchor-wrapper">&nbsp;</div>
  <h2 id="What-has-been-done">What has been done</h2>
  <ul className="ak-ul">
    <li>
      <p>Added satellite creation option during affiliate creation with custom email templates for satellite&rsquo;s
        clients</p>
    </li>
    <li>
  ...
  <h2 id="29/Mar/20---Version-36">29/Mar/20 - Version 36</h2>
  <h2 id="What-has-been-done">What has been done</h2>
  <ul className="ak-ul">
    <li>
    ...
    <li>
      <p>Added new sales status to filters on &lsquo;Client&rsquo;s Search' page (Dialer NA, Dialer New, Dialer
        Assigned, Dialer Failed, Dialer Drop)</p>
    </li>
    <li>
