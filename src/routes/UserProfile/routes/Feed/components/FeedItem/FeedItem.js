      ...
      <div className="row audit-log">
        ...
        <div className="col-xs-11 padding-left-0">
          <div className="first-row">
            <span className="audit-name">Helen Cassar</span> - OP-777h1634
          ...
          <div className="padding-top-5">
            ...
            <span className="hide">Hide details<i className="fa fa-caret-down" />
            </span>
          ...
          <div className="information">
            ...
            <div className="rejection"><span className="rejection_heading">Rejection reason:</span> Sorry, but you`v
