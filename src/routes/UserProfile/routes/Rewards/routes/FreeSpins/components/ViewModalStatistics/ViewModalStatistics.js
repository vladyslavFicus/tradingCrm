...
const ViewModalStatistics = ({ freeSpin }) => (
  <div className="row well">
    <div className="col-md-3 modal-grey-tab">
      ...
      <span className="modal-grey-tab__amount">
    ...
    <div className="col-md-3 modal-grey-tab">
      ...
      <Amount className="modal-grey-tab__amount" {...freeSpin.totalValue} />
    </div>
    <div className="col-md-3 modal-grey-tab">
      <div className="modal-tab-label">
    ...
    <div className="col-md-3 modal-grey-tab">
      ...
      <Amount className="modal-grey-tab__amount" {...freeSpin.winning} />
    </div>
  </div>
);
