  ...
  handleSubmitUserTypeChange = async ({ [fieldNames.USER_TYPE]: userType }) => {
    ...
    if (error) {
      notify({
        ...
        message: I18n.t('PARTNERS.PROFILE.HIERARCHY.ERROR_UPDATE_TYPE'),
      });
    } else {
      ...
      notify({
        ...
        message: I18n.t('PARTNERS.PROFILE.HIERARCHY.SUCCESS_UPDATE_TYPE'),
      });
      refetchHierarchy();
    }
  };
  ...
  handleRemoveBranch = branchId => async () => {
    ...
    if (error) {
      notify({
        level: 'error',
        title: I18n.t('COMMON.FAIL'),
        message: I18n.t('PARTNERS.PROFILE.HIERARCHY.ERROR_REMOVE_BRANCH'),
      });
    } else {
      const { refetchHierarchy } = this.context;
      ...
      notify({
        level: 'success',
        title: I18n.t('COMMON.SUCCESS'),
        message: I18n.t('PARTNERS.PROFILE.HIERARCHY.SUCCESS_REMOVE_BRANCH', { name }),
      });
      ...
      <div className="card">
        <div className="card-body">
          <div className="personal-form-heading margin-bottom-20">
            {I18n.t('PARTNERS.PROFILE.HIERARCHY.LABEL')}
          </div>
          <Choose>
            ...
            <Otherwise>
              ...
              <div className="personal-form-heading margin-bottom-10">
                {I18n.t('PARTNERS.PROFILE.HIERARCHY.BRANCHES')}
              </div>
              <Choose>
                ...
                <Otherwise>
                  <div className="margin-bottom-10">
                    <strong>{I18n.t('PARTNERS.PROFILE.HIERARCHY.NO_BRANCHES')}</strong>
                  </div>
                </Otherwise>
              </Choose>
              <button
              ...
              >
                {I18n.t('PARTNERS.PROFILE.HIERARCHY.ADD_BRANCH_LABEL')}
              </button>
